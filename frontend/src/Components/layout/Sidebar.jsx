...
const navItems = {
  ...
  Manager: [
    ...
    { to: "/tasks", icon: "✅", label: "My Tasks" },
    { to: "/kanban", icon: "📋", label: "Kanban Tasks" },
    { to: "/monitoring", icon: "🛡️", label: "Monitoring Feed" },
    { to: "/manager-review", icon: "👥", label: "Team Review" },
    { to: "/leaves", icon: "📄", label: "Leave Requests" },
    { to: "/alerts", icon: "🔔", label: "System Alerts" },
    { to: "/analytics", icon: "📈", label: "Intelligence" },
    { to: "/reports", icon: "📊", label: "Reports" },
  ],
  Admin: [
